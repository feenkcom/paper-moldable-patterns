...
Moldable development can be understood in terms of a collection of mutually supporting design and process patterns, in other words, a \emph{pattern language}, summarized in \autoref{fig:map}.
These patterns have emerged over several years of experience in developing the \GT moldable development platform, and applying it to numerous projects.
...
An \emph{explainable system} is a software system whose domain model has been exposed with the help of numerous custom tools~\cite{Nier22a}.

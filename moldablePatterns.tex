...
%:===> TODO -- Add Composed Narrative to the map and the body. <===
\todo{Add Composed Narrative to the map and the body.}
...
\end{figure}
%:===> TODO -- Pick more explicit custom search exampl <===
...
\patsec{Known Uses}
%:===> TODO -- Add Known uses of Blind Spot <===

...
\patsec{Solution}
Create a narrative composed of views of various objects or tools, where each view leads to the next by performing a particular action or step.
...
The steps performed may be a \patref{CustomAction}, a \patref{CustomSearch} or evaluating a snippet in a \patref{ContexualPlayground}.

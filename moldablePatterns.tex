...
The figure shows three connected custom inspector views of a running game in Glamorous Toolkit\footnote{\url{https://gtoolkit.com}} (\GT), a moldable development environment \tg{here we talk about MoDE, but later we refer to IDE. I think it would be nice to introduce MDE earlier and talk about that.}.

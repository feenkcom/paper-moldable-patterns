...
\patsec{Problem}
\emph{How do you make it easy to find interesting information again?} \tg{I am not certain about the *again* part. Most often we want a view to be useful the first time we use it. That we can use it a second time is a bonus.}

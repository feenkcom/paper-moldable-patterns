...
Typically this entity will be a live object, but it could be class, or any other kind of software entity.
...
%:===> TODO --- Split Tool Buildup solution into solution and steps <===
\todo{Split Solution and steps}
...
\todo{Need some GT anecdotes. Can we expand on one of the example listed above?}

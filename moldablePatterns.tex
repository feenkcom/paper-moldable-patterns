...
\emph{Prototype new behavior in the contextual playground of the inspector on a \patref{MoldableObject}.}
...
\patsec{Solution}
\emph{Start coding by inspecting a live instance of the class you are coding,
...
\patsec{Solution}
\emph{To start a moldable development activity, you need to have the basic tools available to start exploring.}
...
\patsec{Solution}
\emph{Find the parts of the system that are creating problems for the stakeholders and make them \emph{explainable}.}

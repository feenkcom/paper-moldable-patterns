...
The JetBrains IDE allows you to customize the views of objects within a debugging session, though the custom views are specified in the configuration of the tool itself, not in the context of the object.\footnote{\url{https://www.jetbrains.com/help/idea/customizing-views.html\#renderers}}
...
%:==> TODO -- revise Contextual Playground <==
...
Start with a \patref{SimpleView}, and only add complexity when it is needed.
...
\patsec{Known Uses}
A form of custom searches are supported by the JetBrains IDE\footnote{\url{https://www.jetbrains.com/help/writerside/custom-search-service.html\#request_format}} to support configurable help services.
...
\patsec{Related patterns}
Whenever you develop a \patref{CustomSearch} that returns a collection, consider wrapping it as a \patref{CollectionWrapper}.
...
\patsec{Known Uses}
Jupyter\footnote{\url{https://docs.jupyter.org/}} notebooks are commonly used as both activity logs and as project documentation.

\patsec{Related patterns}
A Project Diary page can embed numerous live \patref{ExampleObject} instance to document specific points.

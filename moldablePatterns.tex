...
\on{Points to mention:
These patterns were mined in the context of GT, but they could work in any environment that supports a minimum of live programming support.
...
}
